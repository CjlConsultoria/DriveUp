...
INSERT INTO drive_up.TB_USUARIO_EMPRESA
    (ID, EMPRESA, CNPJ, TELEFONE, CEP, LOGRADOURO, NUMERO, COMPLEMENTO, BAIRRO, CIDADE, ESTADO, CODIGO_PUBLICO, ID_USUARIO_RESPONSAVEL, DATA_CRIACAO, DATA_ATUALIZACAO)
SELECT 1, 'Empresa Admin', '00.000.000/0001-00', '11940090003', '00000000', 'Rua Principal', '100', NULL, 'Centro', 'CidadeExemplo', 'XX', 'CODIGOPUBLICO001', NULL, NOW(), NOW()
WHERE NOT EXISTS (SELECT 1 FROM drive_up.TB_USUARIO_EMPRESA WHERE ID = 1);
